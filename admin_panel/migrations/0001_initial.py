    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('square', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=5, verbose_name='Площадь (кв.м.)')),
            ],
            options={
                'db_table': 'flat',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(blank=True, default='', max_length=100, verbose_name='')),
                ('indication_val', models.DecimalField(blank=True, decimal_places=1, max_digits=6, null=True, verbose_name='Показания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('', 'Выберите...'), ('new', 'Новое'), ('in work', 'В работе'), ('complete', 'Выполнено')], default='', max_length=50, verbose_name='Статус')),
